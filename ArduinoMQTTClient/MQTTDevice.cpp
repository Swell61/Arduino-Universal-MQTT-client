...
const actionStringToType MQTTDevice::actionStringsToTypes[8] = { {OFF_TEXT, MQTTDevice::ACTION::OFF}, {ON_TEXT, MQTTDevice::ACTION::ON},
...
{WARNING_TEXT, MQTTDevice::ACTION::WARNING}, {ALARM_TEXT, MQTTDevice::ACTION::ALARM} };
